...
import { addUser } from "../../PostRequests";
...
const Register = () => {
    ...
    const handlePasswordConfirmationChange = () => {
        ...
        const validationPassword = passwordConfirmationInput.current.value;
        setPasswordConfirmation(validationPassword);
        ...
        if (password !== validationPassword) {
            document.getElementById("confirmation-password-mistake").innerHTML =
    ...
    const handleDisplayNameChange = (event) => {
        ...
        if (newDisplayName.length < 2) {
            document.getElementById("displayname-mistake").innerHTML =
                "*Display Name must be at least more than 2 characters";
    ...
    const handleImageUpload = (event) => {
        ...
        if (file && file.type.includes("image")) {
            ...
            reader.onload = (e) => {
                ...
                // Save the image on the user local storage
                // localStorage.setItem("userImage", imageDataURL); // old
                previewImageRef.current.src = imageDataURL;
            };
            setIsValidImage(true);
            reader.readAsDataURL(file);
        } else {
            previewImageRef.current.alt = "*Not an image, please upload again";
    ...
    const handleSubmit = async (event) => {
        ...
        if (
            ...
            document.getElementById("submit-mistake").innerHTML =
                "*Make sure all fields are validated and an image was uploaded";
            return;
        }
        ...
        const isValid = await addUser(newUser);
        if (isValid === false) {
            document.getElementById("submit-mistake").innerHTML =
                "*Username is taken";
            return 0;
                                ...
                                <div className="row">
                                    <form
                                        ...
                                        <div className="row">
                                            ...
                                            <div
                                                className="error-message"
                                                id="confirmation-password-mistake"></div>
                                        </div>
                                        <div className="row">
                                            <input
                                                type="text"
                                        ...
                                        <div className="row">
                                            <div className="preview-container">
                                                ...
                                                <img
                                                    ...
                                                    src=""
                                                    alt=" "
                                                    className="preview-image rounded-circle"></img>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row">
                                            <input
                                                type="submit"
                                                value="Submit"
                                                className="btn register-btn"></input>
                                        </div>
                                    </form>
                                </div>
                                <div className="row">
